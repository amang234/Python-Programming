# The Head Librarian at a library wants you to make a program that calculates the fine for returning the book after the 
# return date. You are given the actual and the expected return dates. Calculate the fine as follows:
...
# c. If the book is not returned in the same month but in the same year as the expected return date, 
# Fine = 500 Rupees x Number of late months
